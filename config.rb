...
set :tea, {
  blog: {
    ...
    name: 'Middleman Tea',
    description: 'I brew & code a little.',
    date_format: '%d %B %Y',
    logo: nil
  },
  author: {
    name: 'John Foobar',
    bio: 'Day and night I toil in front of a screen.',
    location: 'Fooburg, Barland',
    website: 'https://github.com/nextbase/middleman-tea.git', 
    gravatar_email: "name@website.com" 
  }
}
